...
void CMSDetector::init_fingerprints() {
    fingerprints = {
        ...
        {"phpMyAdmin", {"/phpmyadmin/"}, {}, {"phpMyAdmin"},
         "/README", "phpMyAdmin.*?([0-9.]+)", "5.2.1"},
        {"MediaWiki", {"/wiki/"}, {"X-Powered-By"}, {"mediawiki"},
         "/api.php?action=siteinfo&format=json", "generator.*?([0-9.]+)", "1.41.0"},
        {"vBulletin", {"/vb/"}, {}, {"vBulletin"},
         "/", "vBulletin.*?([0-9.]+)", "5.7.5"},
        {"phpBB", {"/phpBB/"}, {}, {"phpBB"},
         "/docs/CHANGELOG.html", "phpBB ([0-9.]+)", "3.3.11"},
        {"Craft CMS", {"/cpresources/"}, {"X-Powered-By"}, {"Craft."},
         "/", "Craft CMS ([0-9.]+)", "5.1.0"},
        {"Ghost", {"/ghost/"}, {"X-Powered-By"}, {"ghost-"},
         "/ghost/api/", "version.*?([0-9.]+)", "5.82.0"},
        {"Concrete CMS", {"/concrete/"}, {}, {"concrete5"},
         "/concrete/config/concrete.php", "version.*?([0-9.]+)", "9.2.8"},
        {"Liferay", {"/web/guest"}, {"Liferay-Portal"}, {"Liferay"},
         "/", "Liferay.*?([0-9.]+)", "7.4.3"},
        {"DotNetNuke", {"/DesktopModules/"}, {}, {"DNN"},
         "/", "DNN.*?([0-9.]+)", "9.13.3"},
        ...
        {"Kentico", {"/CMSPages/"}, {}, {"Kentico"},
         "/CMSPages/GetDocLink.ashx", "Kentico.*?([0-9.]+)", "13.0.130"},

        // === Headless / Modern: 21-40 ===
        {"Strapi", {"/admin"}, {"X-Powered-By"}, {"strapi"},
         "/admin/", "strapi.*?([0-9.]+)", "4.22.0"},
        {"Directus", {"/admin/"}, {}, {"directus"},
         "/server/info", "version.*?([0-9.]+)", "10.10.0"},
        {"Contentful", {}, {}, {"contentful.com"}, "/", "", "N/A"},
        {"Sanity", {}, {}, {"sanity.io"}, "/", "", "N/A"},
        {"Payload CMS", {"/admin"}, {}, {"payload"},
         "/api/globals", "version.*?([0-9.]+)", "2.11.0"},
        {"KeystoneJS", {"/admin"}, {}, {"keystone"},
         "/", "keystone.*?([0-9.]+)", "6.3.0"},
        {"Cockpit CMS", {"/cockpit/"}, {}, {"cockpit"},
         "/cockpit/", "cockpit.*?([0-9.]+)", "2.8.0"},
        ...
        {"Saleor", {"/graphql/"}, {}, {"saleor"},
         "/graphql/", "saleor.*?([0-9.]+)", "3.19.0"},
        {"Medusa", {"/store/"}, {}, {"medusa"},
         "/store/", "medusa.*?([0-9.]+)", "1.20.0"},
        {"Sylius", {"/admin/"}, {}, {"sylius"},
         "/", "Sylius.*?([0-9.]+)", "1.12.0"},
        {"nopCommerce", {"/Admin/"}, {}, {"nopCommerce"},
         "/", "nopCommerce.*?([0-9.]+)", "4.70.0"},
        {"osCommerce", {"/catalog/"}, {}, {"osCommerce"},
         "/", "osCommerce.*?([0-9.]+)", "4.0"},
        {"Zen Cart", {"/includes/"}, {}, {"Zen Cart"},
         "/", "Zen Cart.*?([0-9.]+)", "1.5.8"},
        {"CS-Cart", {"/skins/"}, {}, {"cs-cart"},
         "/", "CS-Cart.*?([0-9.]+)", "4.17.0"},
        {"VirtueMart", {"/components/com_virtuemart/"}, {}, {"VirtueMart"},
         "/", "VirtueMart.*?([0-9.]+)", "4.2.0"},
        {"Spree Commerce", {"/spree/"}, {}, {"spree"},
         "/", "spree.*?([0-9.]+)", "4.7.0"},
        {"Adobe Commerce", {"/skin/frontend/"}, {}, {"Magento"},
         "/magento_version", "([0-9.]+)", "2.4.7"},
        {"CommerceTools", {}, {}, {"commercetools.com"}, "/", "", "N/A"},
        {"Vendure", {"/admin/"}, {}, {"vendure"},
         "/", "vendure.*?([0-9.]+)", "2.2.0"},
        {"Drupal Commerce", {"/modules/commerce/"}, {}, {"commerce"},
         "/", "commerce.*?([0-9.]+)", "2.36.0"},

        // === Wiki / Forums / Communities: 56-70 ===
        {"Discourse", {"/categories"}, {}, {"discourse"},
         "/", "discourse.*?([0-9.]+)", "3.2.0"},
        {"Flarum", {"/api/"}, {}, {"flarum"},
         "/api/", "flarum.*?([0-9.]+)", "1.8.5"},
        {"XenForo", {"/community/"}, {}, {"XenForo"},
         "/", "XenForo.*?([0-9.]+)", "2.2.15"},
        {"NodeBB", {"/api/"}, {}, {"nodebb"},
         "/api/config", "version.*?([0-9.]+)", "3.6.0"},
        {"BookStack", {"/books/"}, {}, {"BookStack"},
         "/", "BookStack.*?([0-9.]+)", "24.02"},
        {"DokuWiki", {"/doku.php"}, {}, {"DokuWiki"},
         "/doku.php", "DokuWiki.*?([0-9.]+)", "2024-02-06"},
        {"Wiki.js", {}, {}, {"wiki.js"},
         "/graphql", "wiki.*?([0-9.]+)", "2.5.303"},
        {"Confluence", {"/login.action"}, {"X-Confluence"}, {"Confluence"},
         "/", "Confluence.*?([0-9.]+)", "8.8.0"},
        {"Tiki Wiki", {"/tiki-index.php"}, {}, {"Tiki"},
         "/", "Tiki.*?([0-9.]+)", "27.0"},
        {"MoinMoin", {"/FrontPage"}, {}, {"MoinMoin"},
         "/SystemInfo", "MoinMoin.*?([0-9.]+)", "2.0.0"},
        {"MyBB", {"/member.php"}, {}, {"MyBB"},
         "/", "MyBB.*?([0-9.]+)", "1.8.37"},
        {"Simple Machines Forum", {"/index.php?action=forum"}, {}, {"SMF"},
         "/", "SMF ([0-9.]+)", "2.1.4"},
        {"Vanilla Forums", {"/discussions"}, {}, {"Vanilla"},
         "/", "Vanilla.*?([0-9.]+)", "4.3.0"},
        {"bbPress", {"/forums/"}, {}, {"bbpress"},
         "/wp-content/plugins/bbpress/readme.txt", "Stable tag: ([0-9.]+)", "2.6.9"},
        {"AnswerHub", {"/questions/"}, {}, {"AnswerHub"},
         "/", "AnswerHub.*?([0-9.]+)", "1.7.0"},

        // === Enterprise / DXP: 71-85 ===
        {"Adobe Experience Manager", {"/crx/de"}, {}, {"jcr_root"},
         "/system/console/bundles.json", "([0-9.]+)", "6.5.19"},
        {"SharePoint", {"/_layouts/"}, {"MicrosoftSharePointTeamServices"}, {"SharePoint"},
         "/", "MicrosoftSharePointTeamServices: ([0-9.]+)", "16.0"},
        {"OpenText", {"/otcs/"}, {}, {"OpenText"},
         "/", "OpenText.*?([0-9.]+)", "23.4"},
        {"Alfresco", {"/share/"}, {}, {"Alfresco"},
         "/alfresco/api/-default-/public/alfresco/versions/1", "version.*?([0-9.]+)", "23.2"},
        {"Magnolia", {"/magnoliaAuthor/"}, {}, {"magnolia"},
         "/", "magnolia.*?([0-9.]+)", "6.2.40"},
        {"Acquia", {}, {}, {"acquia.com"}, "/", "", "N/A"},
        {"Bloomreach Experience", {"/cms/"}, {}, {"hippo"},
         "/", "hippo.*?([0-9.]+)", "15.0"},
        {"Oracle WebCenter", {"/webcenter/"}, {}, {"WebCenter"},
         "/", "WebCenter.*?([0-9.]+)", "12.2.1"},
        {"HCL Digital Experience", {"/wps/"}, {}, {"WebSphere"},
         "/", "WebSphere.*?([0-9.]+)", "9.5"},
        {"Jahia", {"/cms/"}, {}, {"jahia"},
         "/", "jahia.*?([0-9.]+)", "8.1.0"},
        {"SDL Tridion", {"/WebUI/"}, {}, {"Tridion"},
         "/", "Tridion.*?([0-9.]+)", "11.0"},
        {"Crownpeak", {}, {}, {"crownpeak.com"}, "/", "", "N/A"},
        {"OpenCms", {"/opencms/"}, {}, {"OpenCms"},
         "/", "OpenCms.*?([0-9.]+)", "16.0"},
        {"Plone", {"/@@overview-controlpanel"}, {"X-Powered-By"}, {"Plone"},
         "/", "Plone.*?([0-9.]+)", "6.0.9"},
        {"eZ Platform", {"/ez/"}, {}, {"eZ Platform"},
         "/", "eZ.*?([0-9.]+)", "4.6.0"},
